...
enum AppInfo {
    ...
    static let latestRelease = URL(string: "https://api.github.com/repos/ninobc/mac-duo/releases/latest")!
    static let latestDMG = URL(string: "https://github.com/ninobc/mac-duo/releases/latest/download/Mac-Duo.dmg")!
